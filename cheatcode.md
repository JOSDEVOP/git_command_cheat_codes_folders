...
- -⚡git checkout commit hash_id: it can help you travel back to a particular commit and you can create a branch from there if there is something you need there.This command takes you into detach HEAD and if you want to switch back to ur normal branch the command git switch - or git switch main can be used.
